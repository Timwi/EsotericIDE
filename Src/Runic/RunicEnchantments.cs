    ...
    sealed class RunicEnchantments : ProgrammingLanguage
    {
        ...
        public override string GetInfo(string source, int cursorPosition)
        {
            ...
            switch (ch)
            {
                ...
                case 'X': returnStr = (modFlag ? "Multiplies" : "Divides") + " the top of the stack by 10."; break;
                case 'C': returnStr = (modFlag ? "Multiplies" : "Divides") + " the top of the stack by 100."; break;
                case 'Y': returnStr = (modFlag ? "Multiplies" : "Divides") + " the top of the stack by 1000."; break;
                ...
                case 's': returnStr = "Pops x, then rotates the " + (modFlag ? "last" : "top") + " |x| " + (substackFlag ? "substacks" : "values on the stack") + ". If x is positive, the top moves to the bottom, else the bottom moves to the top. These values are then put back on the stack."; break;
